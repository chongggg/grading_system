...
<nav class="mb-4 text-sm">
    <ol class="list-none p-0 inline-flex text-gray-400">
        <li class="flex items-center">
            <a href="<?= site_url('teacher/messages') ?>" class="hover:text-white">Messages</a>
    ...
    <div class="card rounded-lg overflow-hidden">
        ...
        <div class="p-6 border-b border-white/10">
            <div class="flex items-center justify-between">
                ...
                <a href="<?= site_url('teacher/delete_thread/' . $thread['thread_id']) ?>" 
...
<?php else: ?>
    <div class="card rounded-lg p-6 text-center">
        ...
        <a href="<?= site_url('teacher/messages') ?>" class="mt-4 inline-block px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
            Back to Messages
        </a>
    </div>
<?php endif; ?>
