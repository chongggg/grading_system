...
<div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="space-y-2 max-h-[600px] overflow-y-auto">
                <?php if (!empty($threads)): ?>
                    <?php foreach ($threads as $thread): ?>
                        <a href="<?= site_url('student/view_thread/' . $thread['thread_id']) ?>" 
    ...
    <div class="md:col-span-2">
        <div class="card rounded-lg p-8 text-center">
            ...
            <p class="text-gray-400 mb-6">Select a conversation from the list to view messages, or start a new conversation with your teachers or administrators.</p>
