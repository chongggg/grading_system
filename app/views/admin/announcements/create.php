...
<head>
    ...
    <style>
        .admin-bg { background: linear-gradient(135deg, #FFFCFB 0%, #E8F9FF 100%); }
        .card { background: #FFFFFF; border: 1px solid rgba(9, 63, 180, 0.1); box-shadow: 0 2px 8px rgba(9, 63, 180, 0.08); }
        .form-input { 
            background: #FFFFFF; 
        ...
        .radio-card { background: #FFFFFF; border: 2px solid rgba(9, 63, 180, 0.2); }
        .radio-card:hover { background: #E8F9FF; transform: translateY(-2px); }
        .radio-card.checked { border-color: #093FB4; background: rgba(9, 63, 180, 0.05); }
...
<body class="min-h-screen admin-bg" style="color: #1e293b;">
    ...
    <!-- Navigation -->
    <nav class="w-full shadow-lg" style="background: #FFFFFF; border-bottom: 2px solid rgba(9, 63, 180, 0.1);">
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    <i class="fas fa-bullhorn text-2xl" style="color: #093FB4;"></i>
                    <h1 class="text-2xl font-bold" style="color: #093FB4;">Create Announcement</h1>
                </div>
    ...
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="card rounded-xl shadow-lg p-6">
            <form method="POST" action="<?= site_url('announcements/create') ?>">
                ...
                <div class="mb-6">
                    ...
                    <div class="space-y-3">
                        <label class="radio-card flex items-center p-4 rounded-lg cursor-pointer transition">
                            <input type="radio" name="role_target" value="all" required class="mr-3 w-4 h-4">
                            <div>
                        ...
                        <label class="radio-card flex items-center p-4 rounded-lg cursor-pointer transition">
                            <input type="radio" name="role_target" value="teacher" required class="mr-3 w-4 h-4">
                            <div>
                                <div class="font-medium" style="color: #1e293b;">
                        ...
                        <label class="radio-card flex items-center p-4 rounded-lg cursor-pointer transition">
                            <input type="radio" name="role_target" value="student" required class="mr-3 w-4 h-4">
                            <div>
                                <div class="font-medium" style="color: #1e293b;">
                ...
                <div class="mb-6 rounded-lg p-4" style="background: #dbeafe; border: 1px solid #93c5fd;">
                    <div class="flex items-start">
                        <i class="fas fa-info-circle mt-1 mr-3" style="color: #1e40af;"></i>
                        <div class="text-sm" style="color: #1e40af;">
                            <strong>Email Notifications:</strong> When you publish this announcement, email notifications will be automatically sent to all selected recipients.
                        </div>
                    </div>
                </div>
                ...
                <div class="flex space-x-4">
                    <button type="submit" 
                        ...
                        <i class="fas fa-paper-plane mr-2"></i>Publish & Send Notifications
                    </button>
