...
<head>
    ...
    <title>Register - Grading Management System</title>
...
<body class="min-h-screen">
    ...
    <nav class="fixed top-0 w-full shadow-lg z-40" style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px);">
        <div class="max-w-6xl mx-auto px-6 py-3 flex justify-between items-center">
            ...
            <div class="text-sm" style="color: #64748b;">Registration Portal</div>
        </div>
    </nav>
    ...
    <div class="min-h-screen flex items-center justify-center pt-20 pb-12 px-4">
        <div class="w-full max-w-lg">
            ...
            <div class="text-center mb-8 slide-in-left">
                ...
                <p style="color: #64748b;">Join our platform today</p>
            </div>
                ...
                <div class="p-8">
                    ...
                    <form method="POST" action="<?= site_url('auth/register') ?>" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                ...
                                <label for="first_name" class="form-label absolute left-4 top-3 pointer-events-none">
                            ...
                            <div class="relative">
                                ...
                                <label for="last_name" class="form-label absolute left-4 top-3 pointer-events-none">
                        ...
                        <div class="relative">
                            ...
                            <label for="email" class="form-label absolute left-4 top-3 pointer-events-none">
                        ...
                        <div class="relative">
                            <select id="grade_level"
                                ...
                                <option value="7" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '7') ? 'selected' : '' ?>>Grade 7</option>
                                <option value="8" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '8') ? 'selected' : '' ?>>Grade 8</option>
                                <option value="9" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '9') ? 'selected' : '' ?>>Grade 9</option>
                                <option value="10" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '10') ? 'selected' : '' ?>>Grade 10</option>
                                <option value="11" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '11') ? 'selected' : '' ?>>Grade 11</option>
                                <option value="12" <?= (isset($_POST['grade_level']) && $_POST['grade_level'] == '12') ? 'selected' : '' ?>>Grade 12</option>
                            </select>
                            <label for="grade_level" class="form-label absolute left-4 top-3 pointer-events-none">
                        ...
                        <div class="relative">
                            ...
                            <label for="confirm_password" class="form-label absolute left-4 top-3 pointer-events-none">
                                <i class="fas fa-lock mr-2"></i>Confirm Password
                            </label>
                        </div>

                        <button type="submit" id="register-btn" class="submit-btn w-full py-3 rounded-lg font-semibold text-white shadow-lg">
                    ...
                    <div class="mt-6 text-center">
                        <p style="color: #64748b;">
                            ...
                            <a href="<?= site_url('auth/login') ?>" class="font-medium underline transition duration-200" style="color: #093FB4;">
                                Sign in here
                            </a>
                        </p>
                    </div>
